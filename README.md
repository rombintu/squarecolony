...
**Honey** - лакомство, случайно упавшее из дома заклятых врагов, пчел и ос. Повышает скорость и силу всех отрядов, немного восполняет здоровье отрядов. Редкость: редкий.    
...
```
## Чат
* Загрузите исходные коды [сервера](https://github.com/ergochat/ergo) и [веб-сервера](https://kiwiirc.com/downloads/) IRC. Настройте для подключения других игроков